...
- [**Models for Reaction Times**](https://dominiquemakowski.github.io/cogmod/articles/rt_models.html)
  ...
  - [x] Shifted LogNormal
  - [x] Shifted Log-Student-t (robust LogNormal, heavy-tailed)
  - [x] Shifted Wald (Inverse Gaussian)
  - [x] Ex-Wald ([Schwarz, 2001](https://link.springer.com/article/10.3758/bf03195403)) - a Wald convolved with an exponential residual stage
