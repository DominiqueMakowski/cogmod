...
We can see how the distribution changes as a function of **x**. Moreover, we can also visualize the
effect of **x** on specific paramaeters, showing that it mostly affects the main parameters **mu**, 
