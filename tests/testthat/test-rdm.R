...
test_that("rrdm behaves correctly under various conditions", {
  ...
  vzero_t1 <- 0.8
  vone_t1 <- 0.6
  sim_data_t1 <- rrdm(n = 100, vzero = vzero_t1, vone = vone_t1, k = k_val, A = A_val, ndt = ndt_val)
  ...
  vzero_21 <- 1.0
  vone_21 <- 0.7
  sim_21 <- rrdm(n = n, vzero = vzero_21, vone = vone_21, k = k_val, A = A_val, ndt = ndt_val)
  ...
  vzero_22 <- 0.6
  vone_22 <- 0.9
  sim_22 <- rrdm(n = n, vzero = vzero_22, vone = vone_22, k = k_val, A = A_val, ndt = ndt_val)
  ...
  vzero_23 <- 0.8
  vone_23 <- 0
  sim_23 <- rrdm(n = n, vzero = vzero_23, vone = vone_23, k = k_val, A = A_val, ndt = ndt_val)
  ...
  vzero_24 <- 0
  vone_24 <- 0.8
  sim_24 <- rrdm(n = n, vzero = vzero_24, vone = vone_24, k = k_val, A = A_val, ndt = ndt_val)
